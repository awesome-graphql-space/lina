...
export class AuthResolvers {
  ...
  async signupWithEmail(@Args() args: CreateUserInput, ctx): Promise<AuthPayload> {
  ...
  async signupWithTwitter(@Args() args: CreateUserInput): Promise<AuthPayload> {
    // const createdany = await this.userService.create(args);
    // pubSub.publish('userCreated', { anyCreated: createdany });
    return null;
  }
  ...
  async signupWithFacebook(@Args() args: CreateUserInput): Promise<AuthPayload> {
    // const createdany = await this.userService.create(args);
    // pubSub.publish('userCreated', { anyCreated: createdany });
    return null;
  }
  ...
  async loginWithEmail(@Args() args: CreateUserInput): Promise<AuthPayload> {
    // const createdany = await this.userService.create(args);
    // pubSub.publish('userCreated', { anyCreated: createdany });
    return null;
  }
  ...
  async user(@Parent() user: User, @Context() ctx): Promise<User|any> {
    return null;
  }
}
